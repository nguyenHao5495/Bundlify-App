...
if (typeof ot_ba_checkJS == "undefined") {
    ...
    // Root Link
    var ot_ba_rootLink = 'https://haolocal.omegatheme.com/omegashopifyapp';
    ...
    function ot_ba_loadFile() {
        $('head').append(`
			<link href="${ot_ba_rootLink}/customer/assets/css/bundle_advance.css?v=${ot_ba_settings.v}" rel="stylesheet" type="text/css" media="all">
		`);
        Shopify.money_format = ot_ba_settings.money_format;
        let currentUrl = window.location.href.split('/');
        if (currentUrl.indexOf('cart') > -1) {

            ot_ba_getScript(`${ot_ba_rootLink}/admin/FrontEnd/cart.js?v=${ot_ba_settings.v}`);
        }
        else if (currentUrl.indexOf('products') > -1) {
            console.log("product");
            ot_ba_getScript(`${ot_ba_rootLink}/admin/FrontEnd/product.js?v=${ot_ba_settings.v}`);
        }
