...
if (typeof ot_bundlfy_checkJS == "undefined") {
    ...
    // Root Link
    var ot_bundlfy_rootLink = 'https://haolocal.omegatheme.com/omegashopifyapp';
    ...
    function ot_bundlfy_loadFile() {
        $('head').append(`
			<link href="${ot_bundlfy_rootLink}/customer/assets/css/bundle_advance.css?v=${ot_bundlfy_settings.v}" rel="stylesheet" type="text/css" media="all">
		`);
        Shopify.money_format = ot_bundlfy_settings.money_format;
        let currentUrl = window.location.href.split('/');
        if (currentUrl.indexOf('cart') > -1) {

            ot_bundlfy_getScript(`${ot_bundlfy_rootLink}/admin/FrontEnd/cart.js?v=${ot_bundlfy_settings.v}`);
        }
        else if (currentUrl.indexOf('products') > -1) {
            console.log("product");
            ot_bundlfy_getScript(`${ot_bundlfy_rootLink}/admin/FrontEnd/product.js?v=${ot_bundlfy_settings.v}`);
        }
